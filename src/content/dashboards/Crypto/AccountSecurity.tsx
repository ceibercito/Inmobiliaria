...
function AccountSecurity() {
  ...
  return (
    <Card>
      <CardHeader title="Seguridad de la Cuenta" />
      <Divider />
      <List disablePadding>
        <ListItem
          sx={{
        ...
        >
          ...
          <ListItemText
            primary={<Text color="black">Autenticacion 2FA </Text>}
            ...
            secondary={<Text color="error">Deshabilitado</Text>}
        ...
        >
          ...
          <ListItemText
            primary={<Text color="black">Verificacion de telefono</Text>}
            primaryTypographyProps={{
              variant: 'body1',
              fontWeight: 'bold',
              color: 'textPrimary',
            ...
            secondary={<Text color="success">Activo</Text>}
            secondaryTypographyProps={{ variant: 'body2', noWrap: true }}
          />
          <Switch
            edge="end"
        ...
        >
          ...
          <ListItemText
            primary={<Text color="black">Recuperacion de email</Text>}
            primaryTypographyProps={{
              variant: 'body1',
              fontWeight: 'bold',
              color: 'textPrimary',
            ...
            secondary={<Text color="warning">No completado</Text>}
            secondaryTypographyProps={{ variant: 'body2', noWrap: true }}
          />
          <Switch
            edge="end"
